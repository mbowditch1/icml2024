...
\section{ToDo}
\listoftodos
Start with accuracy of popular facial recognition systems as multiple backdoors are installed. Citation for these systems being popular. Highlight how accuracy decreases then increases. Section explaining link to simplicity bias (paper that shows intrinsic dimension) mention PCA, show graph projecting in PCA directions. 
